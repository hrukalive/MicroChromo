...
// Accessors
//===------------------------------------------------------------------===//
int PluginBundle::getTotalNumInputChannels() const noexcept
{
    return instances[0]->processor->getTotalNumInputChannels();
}

int PluginBundle::getTotalNumOutputChannels() const noexcept
{
    return instances[0]->processor->getTotalNumOutputChannels();
}

int PluginBundle::getMainBusNumInputChannels() const noexcept
{
    return instances[0]->processor->getMainBusNumInputChannels();
}

int PluginBundle::getMainBusNumOutputChannels() const noexcept
{
    return instances[0]->processor->getMainBusNumOutputChannels();
}
